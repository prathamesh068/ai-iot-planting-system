...
GEMINI_API_KEY = "AIzaSyAKSauJHV8wML5PtQ4-VgzFUmRb2_VgVPg"
...
class WebCamera:
    ...
    def capture():
        ...
        # Force MJPEG (critical for most USB webcams)
...
- When no disease, reply 'disease' with No disease found, set everything to false
- When no plant detected, reply 'plant' with No plant detected
